...
class TestEbcdic {
    ...
    @Test
    void testAscii() throws IOException, ParseException {
    ...
    @Test
    void testEbcdic() throws IOException, ParseException {
    ...
    @Test
    void testParsers() throws UnsupportedEncodingException, ParseException {
    ...
    @Test
    void testMessageType() throws UnsupportedEncodingException, ParseException {
    ...
    @Test
    void testDate4() throws UnsupportedEncodingException, ParseException {
    ...
    @Test
    void testDate10() throws UnsupportedEncodingException, ParseException {
    ...
    @Test
    void testDateExp() throws UnsupportedEncodingException, ParseException {
    ...
    @Test
    void testTime() throws UnsupportedEncodingException, ParseException {
    ...
    @Test
    void testAmount() throws UnsupportedEncodingException, ParseException {
    ...
    @Test
    void testMessage() throws ParseException, UnsupportedEncodingException {
