        ...
        try {
            for (FieldParseInfo fpi : parsers) {
                ...
                if (v != null) {
                    ...
                    if (v.getType() == IsoType.LLVAR || v.getType() == IsoType.LLBIN || v.getType() == IsoType.LLBCDBIN || v.getType() == IsoType.LLBINLENGTHNUM || v.getType() == IsoType.LLBINLENGTHALPHANUM || v.getType() == IsoType.LLBINLENGTHBIN) {
                        pos++;
